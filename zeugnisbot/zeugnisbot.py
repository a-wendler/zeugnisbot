...
dimensionen = ('Erfassen von Lerninhalten', 'Arbeitsweise und Arbeitsverhalten', 'Sozialverhalten')
...
with st.form('zeugnisformular'):
    ...
    for dimension in dimensionen:
        bewertungen[dimension] = st.select_slider(dimension, options=list(range(1,5)), value=1)
